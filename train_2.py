...
from models.CNN_quisutdeus7 import model_cnn_quisutdeus7_3
...
LOG_TRAIN_PATH = './log3/' + SESSION_NAME + '/train/'
LOG_TEST_PATH = './log3/' + SESSION_NAME + '/test/'
...
def train(is_valid):
    ...
    _, xent, optimizer, accuracy = model_FC.make_model(
